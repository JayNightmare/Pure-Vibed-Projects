...
* Treat the AI like your **only developer**.
* You:
  * Define goals, constraints, stack, and vibes.
  * Keep it honest when it messes up (“this doesn’t run, fix X”).
* It:
  * Writes *all* code, tests, docs, etc.
